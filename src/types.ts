...
// Generic JSON-LD entry structure to capture parsed script contents without using `any`.
...
// Multi-audience store type breakdown: { [audience]: { [vertical]: string[] } }
export type StoreTypeBreakdown = Partial<
  Record<
